...
const metrics = [
  {
    icon: Activity,
    label: 'Production',
    items: ['kg / hour', 'pcs / hour', 'throughput trend'],
  ...
  },
  {
    icon: Zap,
    label: 'Energy',
    items: ['Gas consumption', 'Electricity', 'Water usage'],
  ...
  },
  {
    ...
    items: ['Route efficiency', 'Load factor', 'Delivery SLA'],
  ...
  },
  {
    icon: Leaf,
    label: 'CO₂ Footprint',
    items: ['Emissions per kg', 'Scope 1 & 2', 'CSR reporting'],
  ...
  },
  {
    icon: Gauge,
    label: 'OEE Equipment',
    items: ['Availability', 'Performance', 'Quality'],
  ...
  },
  {
    ...
    items: ['Cost per customer', 'SLA compliance', 'Volume trends'],
    ...
    <section className="py-24 px-6 section-alt">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {metrics.map(({ icon: Icon, label, items, iconBg, iconColor }) => (
