...
const palette = {
  emerald: {
    icon: 'bg-emerald-50 dark:bg-emerald-950/50 border-emerald-100 dark:border-emerald-900 text-emerald-500',
    stat: 'text-emerald-600 dark:text-emerald-400',
  },
  sky: {
    icon: 'bg-sky-50 dark:bg-sky-950/50 border-sky-100 dark:border-sky-900 text-sky-500',
    stat: 'text-sky-600 dark:text-sky-400',
  },
  violet: {
    icon: 'bg-violet-50 dark:bg-violet-950/50 border-violet-100 dark:border-violet-900 text-violet-500',
    ...
    <section className="py-24 px-6 section-alt">
      <div className="max-w-5xl mx-auto">
        <AnimateIn className="text-center mb-14">
          <p className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-4">Why it matters</p>
                ...
                <div className="card p-7 h-full">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500">{statLabel}</p>
                    </div>
                  </div>
                  <h3 className="text-slate-900 dark:text-white font-semibold text-lg mb-2">{headline}</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">{detail}</p>
                </div>
              </AnimateIn>
            )
          })}
